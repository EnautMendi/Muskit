...
types = ("OneQubit",) # Types of gates the mutation will change, Valid values are OneQubit and xx
gateNum = (1,3) # Gate number to be replaced and removed.
gapNum = (1,5) # Location number of the gaps that will be used to add gates.
phases = [0,90,180,270] # Phase degrees that will be used to select one value randomly.
